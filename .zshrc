...
# Add Alire toolchains to PATH if present
[[ -d "$HOME/.local/share/alire/toolchains" ]] && {
...
alias env='env | sort'
alias g='git'
alias gb='gprbuild -j0'
alias gclean='gprclean'
alias gd='git diff'
alias gfind='gnatfind'
alias gl='git log --oneline --decorate --graph --max-count=20'
alias gmake='gnatmake -j0'
alias gpp='gnatpp'
alias grep='grep --color=auto'
alias gs='git status'
alias gxref='gnatxref'
alias l='ls -CF'
alias la='ls -A'
alias ll='ls -alF'
